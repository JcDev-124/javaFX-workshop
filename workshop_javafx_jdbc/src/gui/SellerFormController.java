...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		}else if(txtBaseSalary.getText() != null)
	...
	private void setErrorsMessage(Map<String, String> errors) {
		...
		labelErrorBirthDate.setText(  (fields.contains("baseSalary") ? errors.get("birthDate") : "") );
		labelErrorbaseSalary.setText(  (fields.contains("birthDate") ? errors.get("baseSalary") : "") );
